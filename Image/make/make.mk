...
COLLECTED_FILES = Image/HSLAPixel.h Image/HSLAPixel.cpp ImageTransform.h ImageTransform.cpp

# Add standard object files (HSLAPixel, PNG, and LodePNG)
OBJS += Image/HSLAPixel.o Image/PNG.o Image/lodepng/lodepng.o
...
CPP_TEST += Image/catch/catchmain.cpp
...
$(OBJS_DIR):
	...
	@mkdir -p $(OBJS_DIR)/Image/catch
	@mkdir -p $(OBJS_DIR)/Image/lodepng
...
-include $(OBJS_DIR)/*.d
-include $(OBJS_DIR)/Image/*.d
-include $(OBJS_DIR)/Image/catch/*.d
-include $(OBJS_DIR)/Image/lodepng/*.d
